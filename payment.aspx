<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="payment.aspx.cs" Inherits="DS3_Sprint1.payment" %>
...
<head runat="server">
    ...
    <title>Elenas Delicacies Payment Page</title>
    <style>
        main {
...
<div class ="col-sm-4">
   ...
   <form id="form1" runat="server">
    ...
    <div>
        Amount :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; R<asp:TextBox ID="TextBox3" runat="server" ReadOnly="true"></asp:TextBox>
        </br></br>
      ...
      User Name :&nbsp;&nbsp;&nbsp;  <asp:TextBox ID="TextBox1" runat="server" ></asp:TextBox>
        ...
        <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <asp:button runat="server" ID="btnDonate" text="Login" OnClick="btnOrder_Click"/>  <p class="button"><a href="http://itstudents.dut.ac.za/201708/Products"> Cancel </a></p>
    </div>
           </div>
    </form>
</body>
